...
### This script is a record for how each dataset was processed,
### including the final parameters.
### It can also be run to re-process all datasets if desired.
### To rerun, the paths to DATA and RESULTS on lines 9 and 10 need to updated
...
# Process the "neat" sample from the Zymo dataset.
printf "\n**********************************************************************"
printf "\n**********************************************************************\n"
...
# Process the Zymo dilution series with separate samples
printf "\n**********************************************************************"
printf "\n**********************************************************************\n"
